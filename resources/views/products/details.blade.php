<x-app-layout>
    ...
    <section class="mx-2 my-5">
        <nav class="container mx-auto flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700"
    ...
    <section class="mx-2 mt-10">
        <div class=" container mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 ">
            <div>
                <div class="relative">
                    ...
                    <div class="overflow-hidden rounded-lg aspect-w-3 aspect-h-2 ">
                        ...
                        <img id="productMainImage" x-ref="productMainImage"
                            src="{{ $product->getFirstMediaUrl('productImages') }}"
                ...
                <div class="flex overflow-auto gap-1 py-2" id="product-images">
                    {{-- @foreach ($product->images as $image)
                        <img src="{{ $image->image_url }}" alt="Model wearing plain black basic tee."
            ...
            <div class="">
                ...
                <a href="#" class="text-md text-black dark:text-gray-200">Category Name</a>
                <h1 class="text-3xl mt-2  text-black dark:text-gray-100">{{ $product->title }}</h1>
                ...
                <div class="flex items-center my-3">
                    ...
                    <a href="#" class="ml-3 text-sm font-medium text-primary-600 hover:text-primary-500">117
                        reviews</a>
                </div>
                <p class="text-3xl mb-3 tracking-tight text-gray-900 dark:text-gray-100">${{ $product->price }}</p>

                <p class="my-5 text-gray-500">{{ $product->short_desc }}</p>
                <form class="inline" x-data="{ buttonClicked: false }">



                    <template x-if="!buttonClicked">
                        <button type="submit" x-on:click="buttonClicked = ! buttonClicked "
                            class="rounded-md border border-transparent bg-primary-600 py-2 px-3 text-base font-medium text-white hover:bg-primary-700 inline-flex items-center">

                            <svg fill="none" class="inline w-4 h-4 mr-2" stroke="currentColor" stroke-width="1.5"
    ...
    <script>
        ...
        $('#product-images > .sec').click(function(elem) {
            $('#product-images > .sec').addClass('opacity-50')
            $(this).removeClass('opacity-50')

            $('#productMainImage').attr('src', $(this)[0].src)
